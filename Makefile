...
urls: # Affichage de la liste des URL publiques
	...
	@echo "  Application"
	@echo
	@echo "    \033[36mPage d'accueil\033[0m : http://org-incongru-www.localhost"
	@echo
	@echo "  Outils"
	@echo
	@echo "    \033[36mAdminer\033[0m : http://adminer.org-incongru-www.localhost"
	@echo "    \033[36mPortainer\033[0m : http://portainer.org-incongru-www.localhost"
	@echo "    \033[36mTraefik\033[0m : http://traefik.org-incongru-www.localhost"
	@echo